...
export function SettingsPage() {
  return <div className="page list-page"><PageHeader title="系统设置" description="查看匹配规则、数据存储和智能体连接状态。" /><section className="settings-list"><article><span><Bot size={20} /></span><div><h2>业务智能体</h2><p>已接入客户、产品、生态伙伴和资料库知识，支持问答、查询、总结、分析与报告；产品匹配默认关闭。</p></div><StatusTag status="合作中" /></article><article><span><Database size={20} /></span><div><h2>数据存储</h2><p>演示客户数据保存在当前浏览器；生产环境应迁移到具备权限隔离的业务数据库。</p></div><StatusTag status="合作中" /></article><article><span><ShieldCheck size={20} /></span><div><h2>资料库访问</h2><p>管理员密码通过 PBKDF2 派生值验证，解锁状态只在当前会话有效。</p></div><StatusTag status="合作中" /></article><article><span><Workflow size={20} /></span><div><h2>审批声明</h2><p>额度、利率和准入判断统一注明“以资金方最终审批为准”。</p></div><StatusTag status="合作中" /></article></section></div>;
}
